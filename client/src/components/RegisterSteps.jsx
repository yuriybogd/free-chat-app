...
const steps = ["Заполните данные", "Расскажите о себе", "Добавьте фото"]
...
const RegisterSteps = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    const avatarPhoto = localStorage.getItem("avatarStringType")

    localStorage.formState = JSON.stringify({name, email, password, about, city, avatarPhoto})
              ...
              {activeStep === steps.length ? (
                  <React.Fragment>
                    ...
                    <Typography variant="subtitle1">
                      Добро пожаловать на наш бесплатный чат для общения. Где вы можете создавать любые группы для
